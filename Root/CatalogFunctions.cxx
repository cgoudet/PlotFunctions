...
void  ChrisLib::CompareSystModel() {
  ...
  switch (mode){
  case 0 :
    directories = { "h013_ALL", "h013_FULL", "h013_FULLMerge", "h013_FULLNoEta" };
    legends = { "ALL", "FULL", "FULLMerge", "FULLNoEta" };
    prod = "h013";
    break;
  case 1 :
  ...
  vector<string> variables {"mean", "sigma"};
  ...
  for ( auto vVar : variables ) {
    ...
    DrawOptions drawOpt;
    drawOpt.AddOption( "outName", prefix+ "CompareSystModel_" + prod + "_" + vVar );
    ...
    drawOpt.AddOption( "topMargin", "0.13" );
